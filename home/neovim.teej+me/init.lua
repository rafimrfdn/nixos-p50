...
require('which-key').register {
  ...
  -- ignore register this from whichkey
  ['<leader>d'] = "which_key_ignore",  -- special label to hide it in the popup
  ['<leader>e'] = "which_key_ignore",  -- special label to hide it in the popup
  ['<leader>f'] = "which_key_ignore",  -- special label to hide it in the popup
  ['<leader>j'] = "which_key_ignore",  -- special label to hide it in the popup
  ['<leader>k'] = "which_key_ignore",  -- special label to hide it in the popup
  ['<leader>x'] = "which_key_ignore",  -- special label to hide it in the popup
  ['<leader>y'] = "which_key_ignore",  -- special label to hide it in the popup
  ['<leader>Y'] = "which_key_ignore",  -- special label to hide it in the popup

  ['<leader>b'] = { name = '[B]uffers', 
    b = { require('telescope.builtin').buffers, "all" },
    d = {
      name = "close",

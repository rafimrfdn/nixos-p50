...
BACKGROUND_DIR="$HOME/Pictures/wp"
...
CURRENT_BACKGROUND=$HOME/Pictures/wp/$wallpaper
...
sed -i "s|^output \* bg.*|output \* bg $NEXT_BACKGROUND fill|" "$HOME/.config/sway/config"0

...
static const char *fonts[]          = { "Iosevka Term:style=Medium:size=12"};
static const char dmenufont[]       = "Iosevka Term:style=Medium:size=12";
...
static const char *const autostart[] = {
  "sh", "/home/nix/.config/autostart/dwm-autostart.sh", NULL, 
  NULL /* terminate */
};
...
#define SHCMD(cmd) { .v = (const char*[]){ "/run/current-system/sw/bin/sh", "-c", cmd, NULL } }
